...
+++**Mise à jour de maintenance le vendredi 19 décembre 2024**
...
+++**Mise à jour de maintenance le vendredi 12 décembre 2024**
...
**Impossible d’ajouter les champs de tâche « estimateByHours » ou « hoursPerPoint »**
...
Lorsqu’une personne saisit des informations dans un formulaire personnalisé avec une logique d’affichage, les champs qui doivent apparaître en fonction de la logique d’affichage n’apparaissent pas.

#### Page d’accueil

**Les contributeurs et contributrices voient un bouton « Travailler sur cette tâche » non fonctionnel.**

Les contributeurs et contributrices ont accès à un bouton « Travailler sur cette tâche » non fonctionnel dans le widget Mon travail de la page d’accueil.

#### Rapports

**Les trimestres personnalisés n’apparaissent pas dans les invites de rapport.**

Lorsqu’une personne exécute un rapport avec un prompt basé sur des dates, les trimestres personnalisés n’apparaissent pas dans la liste de sélections du prompt.
...
**Impossible de partager des projets en raison d’une erreur « Accès à la suppression »**
...
Lors de l’attribution d’une couleur personnalisée à un groupe dans le créateur de rapports, le choix de couleur n’apparaît pas lors de l’exécution du rapport.
...
Lorsqu’une personne tente d’accéder à un rapport ou à un tableau de bord qui a été partagé avec elle, le rapport ou le tableau de bord est inaccessible.

#### Feuilles de temps

**Les contributeurs ou contributrices utilisent un bouton « Soumettre pour approbation »**
...
**Impossible d’interagir avec les barres de rapport de graphique en barres dans les tableaux de bord**

Lorsque vous essayez de cliquer ou de survoler une barre d’un rapport de graphique en barres dans un tableau de bord, le menu Détails ne s’ouvre pas ou aucune infobulle ne s’affiche, respectivement.
...
**Erreur lors de la création d’une demande depuis Outlook**
...
+++**Mise à jour de maintenance le vendredi 29 août 2024**
...
**Le champ Paramètres régionaux de l’e-mail du profil d’utilisation a été désactivé.**

Pour les organisations sur IMS, les préférences linguistiques sont stockées dans le profil Adobe Experience Cloud de chaque personne. Le champ Paramètres régionaux de l’e-mail du profil d’utilisation Workfront a été désactivé (pour les organisations IMS uniquement). L’info-bulle fournit des instructions sur la façon d’accéder aux paramètres de langue dans le profil Adobe.
...
**Problèmes liés aux cartes en double**
...
**Erreur de type « Oups » lors de la définition des préférences de notification**
...
**Miniatures non visibles dans les notifications par e-mail**
...
**Seule la personne propriétaire du panorama peut mettre à jour les filtres de configuration.**
...
Lorsqu’une personne est taguée dans une mise à jour, elle ne peut pas voir qui l’a taguée. Cela se produit lorsque le paramètre « Les personnes d’autres sociétés ne doivent afficher que les utilisateurs de... » est défini sur « Leur entreprise ».
...
+++**Mise à jour de maintenance le vendredi 29 février 2024**
...
+++**Mise à jour de maintenance le vendredi 22 février 2024**
...
+++**Mise à jour de maintenance le vendredi 15 février 2024**
...
+++**Mise à jour de maintenance le vendredi 8 février 2024**
...
+++**Mise à jour de maintenance le vendredi 1 février 2024**
...
+++**Mise à jour de maintenance le vendredi 25 janvier 2024**
...
+++**Mise à jour de maintenance le vendredi 18 janvier 2024**
...
+++**Mise à jour de maintenance le vendredi 11 janvier 2024**
