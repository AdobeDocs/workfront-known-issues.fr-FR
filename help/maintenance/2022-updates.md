...
description: Mises à jour de maintenance pour [!DNL Adobe Workfront] en 2022
...
ht-degree: 98%
---
# Mises à jour de maintenance de [!DNL Workfront] en 2022
...
« [!UICONTROL Erreur. Désolé ! Seuls les utilisateurs disposant d&#39;une licence de plan peuvent approuver ou rejeter des feuilles de temps. Contactez votre administrateur système.] »
...
* Vos dernières modifications n&#39;ont pas été enregistrées. Actualisez la page pour afficher les dernières modifications enregistrées.
...
+++**Mise à jour de maintenance le vendredi 1 décembre 2022**
...
+++**Mise à jour de maintenance le vendredi 17 novembre 2022**
...
+++**Mise à jour de maintenance le vendredi 10 novembre 2022**
...
+++**Mise à jour de maintenance le vendredi 3 novembre 2022**

**Renommez les sections « Planifier » et « Planification » pour les équipes et les projets dans le modèle de mise en page.**

*Modèles de mise en page*

Les onglets « Planifier » et « Planification » disponibles pouvant être ajoutés dans un modèle de mise en page au panneau de gauche d’une équipe ou d’un projet ont été renommés « Équilibreur de charge de travail ».
...
+++**Mise à jour de maintenance le vendredi 27 octobre 2022**
...
+++**Mise à jour de maintenance le vendredi 20 octobre 2022**
...
+++**Mise à jour de maintenance le vendredi 13 octobre 2022**
...
+++**Mise à jour de maintenance le vendredi 6 octobre 2022**
...
+++**Mise à jour de maintenance le mardi 3 octobre 2022**
...
+++**Mise à jour de maintenance le vendredi 29 septembre 2022**
...
+++**Mise à jour de maintenance le vendredi 22 septembre 2022**
...
+++**Mise à jour de maintenance le vendredi 15 septembre 2022**
...
+++**Mise à jour de maintenance le vendredi 8 septembre 2022**
...
+++**Mise à jour de maintenance le mercredi 6 septembre 2022**
...
+++**Mise à jour de maintenance le samedi 2 septembre 2022**
...
+++**Mise à jour de maintenance le vendredi 1 septembre 2022**
...
+++**Mise à jour de maintenance le vendredi 25 août 2022**
...
+++**Mise à jour de maintenance le vendredi 18 août 2022**
...
+++**Mise à jour de maintenance le samedi 12 août 2022**
...
+++**Mise à jour de maintenance le vendredi 11 août 2022**
...
Lorsqu’une personne convertit un événement en projet et qu’elle inclut un formulaire personnalisé avec des données dans un saut de section pouvant être masquées par la logique de rendu, les données de cette section ne sont pas conservées dans le nouveau projet.
...
Lorsqu’une personne convertit une demande en projet et qu’elle inclut un formulaire personnalisé avec des données dans un saut de section pouvant être masquées par la logique de rendu, les données de cette section ne sont pas conservées dans le nouveau projet.
...
+++**Mise à jour de maintenance le vendredi 4 août 2022**
...
+++**Mise à jour de maintenance le vendredi 28 juillet 2022**
...
+++**Mise à jour de maintenance le vendredi 21 juillet 2022**
...
+++**Mise à jour de maintenance le vendredi 14 juillet 2022**
...
* Mettez à jour vos filtres antispam pour accepter les e-mails provenant de `notification@my.workfront.com`.
...
+++**Mise à jour de maintenance le vendredi 30 juin 2022**
...
+++**Mise à jour de maintenance le vendredi 23 juin 2022**
...
+++**Mise à jour de maintenance le vendredi 16 juin 2022**
...
+++**Mise à jour de maintenance le vendredi 9 juin 2022**
...
+++**Mise à jour de maintenance le vendredi 2 juin 2022**

L’**[!UICONTROL optimisateur de portfolio] indique un score de 0 lors de l’utilisation d’une langue autre que l’anglais**

*Portefeuilles*

Lorsqu’une personne utilise [!DNL Workfront] dans une langue autre que l’anglais et ouvre l’[!UICONTROL optimisateur de portfolio], le score indiqué est de 0. Ce problème peut survenir même lorsque l’analyse de rentabilité n’est pas terminée.
...
Prise en charge des champs personnalisés de type Typehead dans les filtres de l’équilibreur de charge de travail
...
+++**Mise à jour de maintenance le vendredi 26 mai 2022**
...
Les problèmes suivants ont été signalés lors de l’impression d’un tableau de bord dans un PDF :
Le PDF n’imprime pas toutes les lignes du rapport. À l’endroit où il manque des lignes, seuls des espaces vides apparaissent.
...
Lorsque l’utilisateur consulte l’[!UICONTROL équilibreur de charge de travail] depuis un lien partagé, l’[!DNL Workload Balancer] inclut les [!UICONTROL Tâches affectées] dans la section [!UICONTROL Tâches non affectées]. Les [!UICONTROL Tâches affectées] ne comportent pas de section distincte. Lorsqu’une personne consulte l’[!UICONTROL équilibreur de charge de travail] sans utiliser le lien partagé, les [!UICONTROL Tâches affectées] apparaissent normalement.

+++

+++**Mise à jour de maintenance le vendredi 19 mai 2022**
...
+++**Mise à jour de maintenance le vendredi 12 mai 2022**

Le bouton **[!UICONTROL Enregistrer] charge sans cesse lorsqu’un projet est modifié**

*Projets*

Lorsqu’une personne modifie un projet et tente de l’enregistrer, le bouton [!UICONTROL Enregistrer] indique le mot « [!UICONTROL Chargement] ». Si l’utilisateur clique sur ce bouton pour enregistrer les modifications apportées au projet, le bouton ne répond pas et les modifications ne sont pas enregistrées.
...
+++**Mise à jour de maintenance le vendredi 5 mai 2022**
...
Les paramètres de notification par e-mail indiqués dans la zone [!UICONTROL Contacts] de [!DNL Workfront Proof] pour un utilisateur ou une utilisatrice spécifique diffèrent de ceux définis dans les [!UICONTROL Détails de l’utilisateur] en question.
...
+++**Mise à jour de maintenance le vendredi 28 avril 2022**
...
+++**Mise à jour de maintenance le vendredi 21 avril 2022**

**L’ajout d’une tâche décale la page vers le bas**

*Tâches*

Lorsque l’utilisateur ajoute une tâche sous une tâche existante dans une liste, la page est décalée en bas de la liste. Bien que la nouvelle tâche se trouve au bon endroit, vous devez faire défiler la page vers le haut pour la retrouver.
...
+++**Mise à jour de maintenance le vendredi 14 avril 2022**
...
+++**Mise à jour de maintenance le vendredi 7 avril 2022**
...
Lors du partage de rapports avec plusieurs entités indiquées dans la zone [!UICONTROL Accès aux rapports], les utilisateurs et utilisatrices ne peuvent pas faire défiler la page jusqu’au bas de la liste pour consulter la liste complète lorsque le paramètre « [!UICONTROL Visible à l’échelle du système] » est activé.
...
+++**Mise à jour de maintenance le vendredi 31 mars 2022**
...
Lorsqu’une personne remplit les invites d’un rapport et rencontre un sélecteur de date, le sélecteur d’heure en bas du sélecteur de date n’indique pas les heures au-delà du chiffre 2 et les seules valeurs que cette personne peut sélectionner sont 1 ou 2.
...
+++**Mise à jour de maintenance le vendredi 24 mars 2022**
...
Lorsqu’un modèle avec des champs personnalisés obligatoires est joint à un projet dans lequel le champ rempli existe déjà, l’erreur suivante se produit : « [!UICONTROL Certains champs sont incomplets. Saisissez les valeurs des champs obligatoires pour pouvoir continuer.] »
Cliquer sur « [!UICONTROL Y accéder] » permet de constater que les champs sont remplis et que le modèle peut être joint.

**L’[!UICONTROL équilibreur de charge de travail] clignote lorsque vous passez d’une date à l’autre**

*[!UICONTROL Équilbreur de charge de travail]*

Les heures de l’utilisateur répertoriées en premier dans l’[!UICONTROL équilibreur de charge de travail] ne s’affichent pas lorsque la chronologie est mise à jour. L’utilisateur ou l’utilisatrice et ses heures sont remplacés par des carrés gris clignotants. Cela se produit lorsque l’utilisateur avance et recule sur la chronologie.

Mettre à jour le filtre semble réinitialiser l’affichage. Toutefois, si la personne avance et recule sur la chronologie, les carrés clignotants réapparaissent et les heures de l’utilisateur ou de l’utilisatrice disparaissent.
...
Par exemple, sur la page [!UICONTROL Projets], le titre de la page indique toujours « [!UICONTROL Projets] » même si le responsable de l’administration [!DNL Workfront] a modifié le nom des « [!UICONTROL Projets] ».

Cela perturbe les utilisateurs finaux.

+++

+++**Mise à jour de maintenance le vendredi 17 mars 2022**
...
Lorsqu’une personne clique sur une colonne pour la trier, le tri semble fonctionner, mais les résultats reviennent instantanément dans l’ordre d’origine avant qu’elle ne clique sur la colonne. Aucun tri n’est conservé sur aucune colonne.
...
Lors de l’affichage d’un rapport de projet dans la vue [!UICONTROL Jalon], l’erreur « [!UICONTROL APIModel INTERNAL ne prend pas en charge la VIGNETTE namedQuery TILE:milestone-view (UIVW)] » apparaît.
...
+++**Mise à jour de maintenance le vendredi 10 mars 2022**
...
Solution :
Définissez le rôle d’épreuve de l’utilisateur dans son profil sur autre chose, puis réinitialisez-le sur le rôle correct.
...
Vous pouvez désormais déplacer ou copier une tâche vers une autre tâche d’un projet sans disposer des autorisations nécessaires pour ajouter des tâches au projet de destination. Vous devez disposer des autorisations nécessaires pour ajouter des tâches à au moins l’une des tâches du projet de destination. Avant cette mise à jour, vous deviez disposer des autorisations nécessaires pour ajouter des tâches au projet afin de déplacer ou de copier une tâche dans le projet ou dans l’une de ses tâches.  Cette mise à jour est désormais disponible dans l’environnement de production. Elle est sortie dans l’environnement de Prévisualisation en même temps que la mise à jour de maintenance du 24 mars 2022.

REMARQUE : cette mise à jour sera disponible dans l’environnement de production lors de la copie ou du déplacement d’événements après la sortie de la version de production 22.2. Pour plus d’informations sur la version actuelle, consultez workfront.com/release.
...
+++**Mise à jour de maintenance le vendredi 3 mars 2022**
...
Lorsqu’une personne consulte un rapport, le message d’erreur suivant apparaît dans l’en-tête du rapport :
...
REMARQUE : cette mise à jour est sortie dans l’environnement de Prévisualisation le 24 février et sera disponible dans l’environnement de production le 3 mars.
...
+++**Mise à jour de maintenance le vendredi 24 février 2022**
...
**« [!UICONTROL Ce processus d’approbation peut être utilisé par...] » champ manquant**
...
REMARQUE : cette mise à jour sortira dans l’environnement de Prévisualisation le 24 février et sera disponible dans l’environnement de production le 3 mars.
...
REMARQUE : cette mise à jour sera disponible dans l’environnement de production lors de la copie ou du déplacement de tâches à partir du 10 mars. Cette mise à jour sera disponible dans l’environnement de production lors de la copie ou du déplacement d’événements au moment de la sortie de la version de production 22.2. Pour plus d’informations sur la version actuelle, consultez workfront.com/release.
...
+++**Mise à jour de maintenance le vendredi 17 février 2022**
...
+++**Mise à jour de maintenance le vendredi 10 février 2022**
...
+++**Mise à jour de maintenance le vendredi 3 février 2022**

Erreur **[!UICONTROL BizContext] lors de la connexion**

*Connexion*

Lorsqu’une personne tente de se connecter à [!DNL Workfront], la connexion échoue et le message suivant apparaît :
...
+++**Mise à jour de maintenance le vendredi 27 janvier 2022**
...
+++**Mise à jour de maintenance le vendredi 20 janvier 2022**
...
+++**Mise à jour de maintenance le vendredi 13 janvier 2022**
...
+++**Mise à jour de maintenance le vendredi 6 janvier 2022**
