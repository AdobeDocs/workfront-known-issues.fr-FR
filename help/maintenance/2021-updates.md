...
+++**Mise à jour de maintenance le vendredi 23 décembre 2021**
...
+++**Mise à jour de maintenance le vendredi 16 décembre 2021**
...
Lorsque l’utilisateur crée un filtre dans l’[!UICONTROL équilibreur de charge de travail] à l’aide du champ [!UICONTROL Affectation:Role ID], la zone [!UICONTROL Tâches non affectées] ne se charge pas.
...
+++**Mise à jour de maintenance le vendredi 9 décembre 2021**
...
+++**Mise à jour de maintenance le jeudi 8 décembre 2021**
...
+++**Mise à jour de maintenance le vendredi 2 décembre 2021**
...
+++**Mise à jour de maintenance le vendredi 18 novembre 2021**
...
+++**Mise à jour de maintenance le vendredi 11 novembre 2021**
...
+++**Mise à jour de maintenance le vendredi 4 novembre 2021**
...
Lorsque l’utilisateur fait glisser une carte dans une nouvelle colonne du Storyboard, il voit la carte qui se déplace. Toutefois, lorsqu’il la dépose dans la nouvelle colonne, celle-ci apparaît brièvement dans la colonne d’origine avant de s’afficher dans la nouvelle colonne.
...
**Des pages ne se chargent pas dans le [!DNL Firefox] navigateur**
...
+++**Mise à jour de maintenance le vendredi 28 octobre 2021**
...
+++**Mise à jour de maintenance le vendredi 21 octobre 2021**
...
+++**Mise à jour de maintenance le jeudi 20 octobre 2021**
...
Lorsqu’une personne dans la nouvelle expérience [!DNL Workfront] crée une demande et tente d’affecter un utilisateur ou utilisatrice en saisissant son nom dans le champ [!UICONTROL Affectations], la liste déroulante n’apparaît pas dans le champ et elle ne peut pas sélectionner le nom de la personne affectée.
...
+++**Mise à jour de maintenance le vendredi 14 octobre 2021**
...
Lorsqu’une personne tente de créer un projet à partir d’un modèle contenant un formulaire personnalisé avec une section visible uniquement par les responsables de l’administration, la création du projet est impossible et le message suivant apparaît :
...
+++**Mise à jour de maintenance le vendredi 30 septembre 2021**
...
+++**Mise à jour de maintenance le vendredi 23 septembre 2021**
...
+++**Mise à jour de maintenance le vendredi 16 septembre 2021**
...
Lorsqu’une personne consulte un rapport avec une mise en forme conditionnelle modifiant la couleur du texte, la couleur du texte ne change pas à l’écran.

+++

+++**Mise à jour de maintenance le vendredi 9 septembre 2021**

**Les événements n’affichent pas les détails de l’événement**

_Page d’accueil_

Lorsqu’une personne sélectionne un événement de la [!UICONTROL Liste de travail] dans la nouvelle expérience [!DNL Adobe Workfront], certains champs sont vides dans l’aperçu du panneau de droite. Lorsque l’utilisateur ouvre l’événement et consulte les [!UICONTROL Détails de l’événement], ces champs contiennent toutefois des valeurs.
...
+++**Mise à jour de maintenance le vendredi 2 septembre 2021**
...
+++**Mise à jour de maintenance le vendredi 26 août 2021**
...
+++**Mise à jour de maintenance le vendredi 19 août 2021**
...
Lorsqu’une personne dans [!DNL Adobe Workfront Classic] sélectionne un événement de la [!UICONTROL Liste de travail], certains champs sont vides dans l’aperçu du panneau de droite. Lorsque l’utilisateur ouvre l’événement et consulte les [!UICONTROL Détails de l’événement], ces champs contiennent toutefois des valeurs.

+++

+++**Mise à jour de maintenance le vendredi 12 août 2021**
...
Lorsqu’un utilisateur ou une utilisatrice charge une nouvelle version d’un document, le nom du document ne s’adapte pas au nom de la version la plus récente.
...
+++**Mise à jour de maintenance le vendredi 5 août 2021**
...
+++**Mise à jour de maintenance le vendredi 29 juillet 2021**
...
+++**Mise à jour de maintenance le vendredi 22 juillet 2021**
...
+++**Mise à jour de maintenance le vendredi 15 juillet 2021**
...
+++**Mise à jour de maintenance le vendredi 1 juillet 2021**
...
+++**Mise à jour de maintenance le vendredi 24 juin 2021**
...
+++**Mise à jour de maintenance le vendredi 17 juin 2021**
...
+++**Mise à jour de maintenance le vendredi 10 juin 2021**
...
+++**Mise à jour de maintenance le vendredi 3 juin 2021**
...
Lorsqu’une personne accède à la page [!UICONTROL Créer une nouvelle épreuve] dans [!DNL Workfront Proof] et que son contenu est traduit dans une langue autre que l’anglais, certaines phrases restent en anglais.
...
+++**Mise à jour de maintenance le vendredi 27 mai 2021**
...
Lorsque l’utilisateur dans la nouvelle expérience [!DNL Workfront] tente d’ouvrir certains objets, le message d’erreur « [!UICONTROL (L’objet) n’existe plus. L’adresse Web est peut-être mal orthographiée. Vérifiez à nouveau et réessayez.] » Le lien de l’objet s’affiche toujours dans les listes, les éléments récents, les favoris, les résultats de recherche, etc., mais il n’est pas accessible et il n’apparaît pas dans la Corbeille avec les objets supprimés.



+++

+++**Mise à jour de maintenance le vendredi 20 mai 2021**
...
+++**Mise à jour de maintenance le vendredi 13 mai 2021**
...
+++**Mise à jour de maintenance le vendredi 6 mai 2021**
...
* Les listes n’autorisent pas la saisie des abréviations des devises lors de l’utilisation de paramètres régionaux autres que l’anglais
...
+++**Mise à jour de maintenance le vendredi 29 avril 2021**
...
+++**Mise à jour de maintenance le vendredi 22 avril 2021**
...
+++**Mise à jour de maintenance le vendredi 15 avril 2021**
...
+++**Mise à jour de maintenance le vendredi 8 avril 2021**
...
+++**Mise à jour de maintenance le vendredi 1 avril 2021**
...
+++**Mise à jour de maintenance le samedi 26 mars 2021**
...
Lorsque l’utilisateur utilise un terme de l’API [!DNL Workfront] pour sélectionner un champ de collection ou de référence à inclure dans la sortie d’un module [!DNL Workfront], la sortie de ce module affiche ce champ avec deux points (par exemple [!UICONTROL propriétaire:name]) et dans les attributs (le nom est un champ sous le propriétaire). Le champ contenant les deux points est vide et renvoie des données incorrectes s’il est plus tard mappé à un module dans le scénario.
...
+++**Mise à jour de maintenance le vendredi 18 mars 2021**
...
+++**Mise à jour de maintenance le vendredi 11 mars 2021**
...
+++**Mise à jour de maintenance le vendredi 4 mars 2021**
...
+++**Mise à jour de maintenance le vendredi 25 février 2021**
...
Lorsqu’un utilisateur ou une utilisatrice de la nouvelle expérience [!DNL Workfront] charge une nouvelle version d’un document avec un nom différent, le nom ne s’adapte pas au nom de la version la plus récente.
...
+++**Mise à jour de maintenance le vendredi 18 février 2021**
...
Lorsque l’utilisateur dans la nouvelle expérience [!DNL Workfront] clique sur certains liens de document, il ne peut pas accéder au document et le message d’erreur suivant apparaît : « [!UICONTROL Le document n’existe plus. L’adresse Web est peut-être mal orthographiée. Vérifiez à nouveau et réessayez.] » La même erreur se produit avec le lien [!UICONTROL Afficher les détails] dans les notifications par e-mail concernant les épreuves.
...
Cette mise à jour corrige le problème d’affichage des fuseaux horaires dans [!DNL Fusion] 2.0. Les utilisateurs et utilisatrices peuvent désormais voir leur fuseau horaire sous les champs de saisie de dates.

+++

+++**Mise à jour de maintenance le vendredi 11 février 2021**
...
Lorsqu’une personne épingle plus de 60 pages, la barre de navigation supérieure disparaît, ce qui l’empêche d’accéder à [!UICONTROL Rechercher], [!UICONTROL Menu principal], [!UICONTROL Notifications], etc.
...
+++**Mise à jour de maintenance le vendredi 4 février 2021**

**Les rapports exportés affichent l’image de [!DNL Workfront Classic] marque**
...
+++**Mise à jour de maintenance le vendredi 28 janvier 2021**
...
+++**Mise à jour de maintenance le vendredi 21 janvier 2021**
...
+++**Mise à jour de maintenance le vendredi 14 janvier 2021**
...
+++**Mise à jour de maintenance le vendredi 7 janvier 2021**
