...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + Problèmes actifs dans [!DNL Adobe Workfront] {#wf-current}
      ...
      + [BAT : la génération de BAT est extrêmement lente](/help/known-issues/known-issues-workfront/wf-proofs-generation-takes-long-time.md)
      ...
      + [Groupes : le statut du groupe supprimé réapparaît.](known-issues-workfront/wf-groups-deleted-status-reappears.md)
      ...
      + [Workfront : impossible d’utiliser l’authentification SSO](known-issues-workfront/wf-workfront-cannot-use-sso.md)
      ...
      + [Accueil : la page d’accueil se bloque avec une erreur « Mémoire insuffisante ».](known-issues-workfront/wf-home-crashes-with-error.md)
      ...
      + [Rapports : erreur « Aucune donnée à afficher » lorsque le nom du regroupement comporte une barre oblique ou une barre oblique inversée.](known-issues-workfront/wf-reports-chart-drilldown-had-no-data.md)
      ...
      + [Feuilles de temps : la feuille de temps épinglée dirige vers une page vierge.](known-issues-workfront/inactive/wf-timesheets-pinned-goes-to-blank-page.md)
...
+ [!DNL Adobe Workfront Fusion] {#fusion}
   ...
   + Problèmes actifs dans [!DNL Workfront Fusion] {#fusion-current}
      ...
      + [Workfront Fusion : formatage de sortie pour les dates](known-issues-workfront-fusion/fusion-output-formatting-for-dates.md)
