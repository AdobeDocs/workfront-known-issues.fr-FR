...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + Problèmes actifs dans [!DNL Adobe Workfront] {#wf-current}
      ...
      + [BAT : problèmes de traitement des fichiers statiques](known-issues-workfront/wf-proofs-discrepancies-in-new-tool.md)
      ...
      + [Rapports : le rapport Heure budgétée ne se met pas à jour toutes les heures comme prévu](known-issues-workfront/wf-reports-report-not-updating.md)
      ...
      + [Accueil : les widgets Mes projets et Mes tâches n’affichent que 25 éléments](known-issues-workfront/wf-home-widgets-show-25-items.md)
      + [Statut : erreur [!UICONTROL Oups] lors du masquage du statut](known-issues-workfront/wf-setup-whoops-when-hiding-status.md)
      + [Mises à jour : certaines mises à jour sont manquantes dans la nouvelle expérience de commentaire](known-issues-workfront/wf-updates-not-visible-in-new-experience.md)
      ...
      + [Documents : impossible d’accéder à  [!DNL SharePoint]](known-issues-workfront/wf-docs-sharepoint-authorization-required.md)
      ...
      + [Tableaux de bord : la personne ne peut pas accéder aux [!UICONTROL Tableaux de bord Zone de travail]](known-issues-workfront/wf-dashboards-no-access-to-canvas-dasboards.md)
      + [Tâches : erreur [!UICONTROL « Oups »] dans l’en-tête de la tâche](known-issues-workfront/wf-tasks-whoops-error-in-task-header.md)
      ...
      + [Accueil : les projets et tâches ne se chargent pas dans Accueil](known-issues-workfront/wf-home-my-projects-tasks-widget.md)
      + [Documents : le bouton Partager ne fonctionne pas](known-issues-workfront/wf-documents-share-button-not-working.md)
      + [Documents : l’option [!UICONTROL Envoyer à] génère une page vierge et un message d’erreur](known-issues-workfront/wf-documents-sent-to-goes-blank.md)
      + [Mises à jour : « [!UICONTROL Supprimé] » s’affiche en tant que nom d’utilisateur ou d’utilisatrice dans les mises à jour système lorsque le problème est converti en tâche](known-issues-workfront/wf-updates-deleted-requested-team.md)
      + [Connexion : la page de connexion redirige vers la page de destination de déconnexion](known-issues-workfront/wf-login-redirects-to-logout-page.md)
      + [Notifications : les personnes ne sont pas informées des réponses sur un fil de commentaires](known-issues-workfront/wf-notifications-reply-notif-not-received.md)
      + [[!DNL Workfront] : le branding n’est pas appliqué](known-issues-workfront/wf-workfront-branding-not-applied.md)
      + [Panoramas : le mode Panorama dans la zone [!UICONTROL Tâches] du projet ne se charge pas](known-issues-workfront/wf-boards-view-on-task-list-does-not-load.md)
      + [BAT : l’onglet [!UICONTROL Activité du BAT] ne s’ouvre pas](known-issues-workfront/wf-proof-activities-tab-not-working.md)
      + [Tâches : le [!UICONTROL nombre d’heures prévues] est réaffecté lorsqu’une personne supplémentaire est affectée à une tâche](known-issues-workfront/wf-tasks-hours-redistributed-assignee-added.md)
      ...
      + [Panoramas : les cartes sans titre s’affichent dans la liste d’attente](known-issues-workfront/wf-boards-untitled-cards-displaying-and-saved.md)
      + [BAT : la génération des BAT prend un temps excessif](known-issues-workfront/wf-proofs-proof-takes-days-to-generate.md)
      ...
      + [BAT : les BAT semblent désaturés ou recadrés](known-issues-workfront/wf-proofs-desaturated-and-cropped.md)
      ...
      + [Mises à jour : le commentaire s’affiche comme envoyé par une personne incorrecte](known-issues-workfront/wf-updates-comment-displays-as-wrong-user.md)
      + [Panoramas : impossible d’affecter une personne à un panorama sur un flux de travail](known-issues-workfront/wf-boards-cannot-add-user-to-workstream-board.md)
      ...
      + [Épreuves : la mise en forme du texte dans l’épreuve statique ne correspond pas à celle dans le site web.](known-issues-workfront/wf-proofs-text-not-bolded-in-static-proof.md)
      ...
      + [Épreuves : impossible de créer l’épreuve à partir du PDF](known-issues-workfront/wf-proofs-cannot-create-from-pdf.md)
      ...
      + [Épreuves : les couleurs de l’épreuve s’affichent de manière incorrecte.](known-issues-workfront/wf-proof-inaccurate-colors.md)
      ...
      + [Épreuves : chevauchement de texte sur une épreuve](known-issues-workfront/wf-proofs-overlapping-text.md)
      + [Épreuves : le paramètre [!UICONTROL Désactiver les notifications par e-mail de l’épreuve] s’affiche de manière incorrecte.](known-issues-workfront/wf-proofs-disable-email-inaccurate.md)
      ...
      + [Épreuves : impossible d’ajuster les annotations de l’épreuve](known-issues-workfront/wf-proof-markup-tools-not-working.md)
      + [Épreuves : la génération des épreuves échoue.](known-issues-workfront/wf-proofs-fail-to-generate.md)
      + [Épreuves : la création d’une nouvelle version de l’épreuve supprime toutes les versions de l’épreuve.](known-issues-workfront/wf-proofs-new-proof-version-causes-proofs-to-go-to-trash.md)
      + [Épreuves : l’épreuve approuvée reste sur la [!UICONTROL liste de travail de l’accueil].](known-issues-workfront/wf-proofs-proofs-stuck-in-worklist-august.md)
      + [Épreuves : l’épreuve affiche une coupure dans sa partie supérieure.](known-issues-workfront/wf-proofs-proof-displays-with-top-cut-off.md)
      + [Accueil : impossible de supprimer l’élément [!UICONTROL Tâches] dans la nouvelle expérience [!UICONTROL Accueil]](known-issues-workfront/wf-home-cannot-delete-todo.md)
      + [Épreuves : impossible de sélectionner du texte dans des listes ou des puces](known-issues-workfront/wf-proofs-cannot-select-text-in-lists.md)
      ...
      + [Épreuves : les épreuves n’apparaissent pas comme approuvées dans les rapports.](known-issues-workfront/wf-proofs-not-showing-approved-in-report.md)
      + [Épreuves : message « Aucune image » lors d’un clic sur une épreuve](known-issues-workfront/wf-proofs-no-image-on-comment.md)
