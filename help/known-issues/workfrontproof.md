...
| **Problème** | **Dernière modification** |
| -----------------------------------------------------------------| ----------------- |
| [Workfront Proof : le contenu ne se colle pas correctement dans la section Mises à jour de la visionneuse de vérification de l’appli de bureau](known-issues-workfront-proof/proof-wrong-content-pastes-in-viewer-updates.md) | vendredi 19 septembre 2024 |
