...
| --- | --- |
| [Demandes : les files d’attente de demandes apparaissent plusieurs fois](known-issues-workfront/wf-requests-queues-duplicated.md) | 5 janvier 2026 |
| [Utilisateurs : impossible de mettre à jour l’accès utilisateur](known-issues-workfront/wf-users-no-access-to-view-finance-when-changing-access.md) | 5 janvier 2026 |
