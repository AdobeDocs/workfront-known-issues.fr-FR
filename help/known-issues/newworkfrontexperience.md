...
| --- | --- |
| [Formulaires personnalisés : la logique d’affichage ne s’affiche pas correctement sur le formulaire de demande](known-issues-workfront/wf-custom-forms-display-logic-not-triggering.md) | vendredi 29 janvier 2026 |
| [Connexion : Workfront ne se charge pas après la connexion](known-issues-workfront/wf-login-wf-does-not-load.md) | vendredi 29 janvier 2026 |
| [Équilibreur de charge de travail : les heures par utilisateur ne sont pas calculées correctement](known-issues-workfront/wf-workload-balancer-hours-per-user-not-correct.md) | vendredi 29 janvier 2026 |
| [Utilisateurs et utilisatrices : les utilisateurs et utilisatrices ne sont pas correctement configurés dans l’Adobe Admin Console.](known-issues-workfront/wf-users-on-other-consoles-not-provisioning.md) | 7 janvier 2026 |
| [Utilisateurs et utilisatrices : impossible de mettre à jour l’accès des utilisateurs et utilisatrices](known-issues-workfront/wf-users-no-access-to-view-finance-when-changing-access.md) | 5 janvier 2026 |
| [Rapports : la requête du lac de données ne renvoie pas les résultats attendus.](known-issues-workfront/wf-reports-data-lake-not-return-expected-results.md) | 5 janvier 2026 |
...
| **Problème** | **Dernière modification** |
| --- | --- |
| [Demandes : « Aucun objet » s’affiche dans la liste des demandes](known-issues-workfront/wf-requests-no-subject.md) | mardi 2 février 2026 |
| [Demandes : le brouillon créé avec la demande entraîne des problèmes](known-issues-workfront/wf-requests-issues-with-drafts.md) | vendredi 29 janvier 2026 |
...
| [Demandes : problèmes liés aux brouillons dans la nouvelle expérience de demande](known-issues-workfront/wf-requests-issues-with-drafts.md) | 7 janvier 2026 |
...
| [Approbations : les boutons de décision d’approbation ne s’affichent pas dans la visionneuse d’épreuve.](known-issues-workfront/wf-approvals-decision-buttons-not-in-proof-viewer.md) | 30 septembre 2025 |
...
| [Documents : chargement impossible dans la liste des documents du dossier AEM](/help/known-issues/known-issues-workfront/wf-documents-cannot-upload-to-aem-folder.md) | 27 février 2025 |
...
| [Notifications : e-mails en double](/help/known-issues/known-issues-workfront/wf-notifications-duplicate-emails.md) | 27 février 2025 |
